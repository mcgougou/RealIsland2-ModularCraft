...
//.addCatalystInput(<torcherino:blocktorcherino>, ["Reduced speed cost by 80%"], [RecipeModifierBuilder.create("modularmachinery:duration", "input", 0.2, 1, false).build()]).setChance(0)
//.addCatalystInput(<torcherino:blockcompressedtorcherino>, ["Reduced speed cost by 96%"], [RecipeModifierBuilder.create("modularmachinery:duration", "input", 0.04, 1, false).build()]).setChance(0)
//.addCatalystInput(<torcherino:blockdoublecompressedtorcherino>, ["Reduced speed cost by 99.2%"], [RecipeModifierBuilder.create("modularmachinery:duration", "input", 0.008, 1, false).build()]).setChance(0)
...
//.addCatalystInput(<torcherino:blocktorcherino>, ["Reduced speed cost by 80%，但能耗会提升5倍"], [RecipeModifierBuilder.create("modularmachinery:duration", "input", 0.2, 1, false).build(),RecipeModifierBuilder.create("modularmachinery:energy", "input", 5, 1, false).build()]).setChance(0)
.addCatalystInput(<torcherino:blocktorcherino>, ["Reduced speed cost by 80%"], [RecipeModifierBuilder.create("modularmachinery:duration", "input", 0.2, 1, false).build()]).setChance(0)
...
*/
//泥土制造机
RecipeBuilder.newBuilder("nituzhizao1","nituzhizaoji",5)
.addCatalystInput(<torcherino:blocktorcherino>, ["Reduced speed cost by 80%"], [RecipeModifierBuilder.create("modularmachinery:duration", "input", 0.2, 1, false).build()]).setChance(0)
.addItemInput(<mekanism:biofuel>*32)
.addItemOutput(<minecraft:dirt>*18)
.build();
RecipeBuilder.newBuilder("nituzhizao2","nituzhizaoji",5)
.addCatalystInput(<torcherino:blocktorcherino>, ["Reduced speed cost by 80%"], [RecipeModifierBuilder.create("modularmachinery:duration", "input", 0.2, 1, false).build()]).setChance(0)
.addItemInput(<real_island_mod:youjishengwuranliao>*32)
.addItemOutput(<minecraft:dirt>*96)
.build();
//大型压力室
...
.build();
RecipeBuilder.newBuilder("claclulatdianl","dianlujiagongji",20)
.addCatalystInput(<torcherino:blocktorcherino>, ["Reduced speed cost by 80%"], [RecipeModifierBuilder.create("modularmachinery:duration", "input", 0.2, 1, false).build()]).setChance(0)
.addEnergyPerTickInput(5000)
.addItemInput(<calculator:circuitboard>.withTag({Stable: 1, Analysed: 1 as byte}))
.addItemInput(<calculator:circuitboard:1>.withTag({Stable: 1, Analysed: 1 as byte}))
.addItemInput(<calculator:circuitboard:2>.withTag({Stable: 1, Analysed: 1 as byte}))
.addItemInput(<calculator:circuitboard:3>.withTag({Stable: 1, Analysed: 1 as byte}))
.addItemInput(<calculator:circuitboard:4>.withTag({Stable: 1, Analysed: 1 as byte}))
.addItemInput(<calculator:circuitboard:5>.withTag({Stable: 1, Analysed: 1 as byte}))
.addItemInput(<calculator:circuitboard:6>.withTag({Stable: 1, Analysed: 1 as byte}))
.addItemInput(<calculator:circuitboard:7>.withTag({Stable: 1, Analysed: 1 as byte}))
.addItemInput(<calculator:circuitboard:8>.withTag({Stable: 1, Analysed: 1 as byte}))
.addItemInput(<calculator:circuitboard:9>.withTag({Stable: 1, Analysed: 1 as byte}))
.addItemInput(<calculator:circuitboard:10>.withTag({Stable: 1, Analysed: 1 as byte}))
.addItemInput(<calculator:circuitboard:11>.withTag({Stable: 1, Analysed: 1 as byte}))
.addItemInput(<calculator:circuitboard:12>.withTag({Stable: 1, Analysed: 1 as byte}))
.addItemInput(<calculator:circuitboard:13>.withTag({Stable: 1, Analysed: 1 as byte}))
